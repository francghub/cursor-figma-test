...
export default function LogoAnimated({ size = 24, className = "", onClick }: LogoAnimatedProps) {
  const handleClick = () => {
  ...
  return (
    ...
    >
      ...
      />
      {/* Animated Sparks */}
      <line className="spark-1" x1="140" y1="25" x2="140" y2="5" stroke="currentColor" strokeWidth="10" strokeLinecap="round"/>
      <line className="spark-2" x1="165" y1="35" x2="185" y2="25" stroke="currentColor" strokeWidth="10" strokeLinecap="round"/>
      <line className="spark-3" x1="165" y1="55" x2="185" y2="65" stroke="currentColor" strokeWidth="10" strokeLinecap="round"/>
    </svg>
  );
}
